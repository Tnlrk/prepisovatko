...
class App(ctk.CTk, TkinterDnD.DnDWrapper):
    ...
    def _help(self) -> None:
        ...
        txt.insert("1.0",
            ...
            "   termíny, které v nahrávce zazní — přepis je pak mnohem častěji\n"
            "   zapíše správně (zaručené to není).\n"
            "   Slovník si aplikace pamatuje i po zavření.\n"
            "4. Spusť přepis. Během přepisu můžeš upravovat frontu i přepínat\n"
            "   výkon (viz VÝKON PŘEPISU níže).\n"
